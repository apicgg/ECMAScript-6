...
var scoreNick = 85
var pass = 51
if (scoreJohn >= pass && scoreNick >= pass) {
   console.log('Both passed');
} else if (scoreJohn >= pass || scoreNick >= pass) {
   console.log("One passed");

   if (scoreNick > scoreJohn) {
      console.log('Nick passed with' + ' ' + scoreNick);
   } else {
      console.log('John passed with' + ' ' + scoreJohn);
   }
} else {
